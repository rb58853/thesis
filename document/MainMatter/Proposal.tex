...
\item \verb|pred-iou-thresh:| define el umbral para la intersección sobre la unión (IOU)\supindex{}{Intersection Over Union.} en las predicciones. Aumentar este valor puede resultar en menos regiones propuestas, acelerando el proceso de segmentación.
